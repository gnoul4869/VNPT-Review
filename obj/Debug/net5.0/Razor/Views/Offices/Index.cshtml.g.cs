#pragma checksum "C:\Users\gnoul\Synced Folder\Google Drive\Web\_webapp\VNPT_Review\Views\Offices\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "747e7e2a5b26d1fa103b04ef48033b5893425afd"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"747e7e2a5b26d1fa103b04ef48033b5893425afd", @"/Views/Offices/Index.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "747e7e2a5b26d1fa103b04ef48033b5893425afd4724", async() => {
                WriteLiteral("Thêm");
            }
            );
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "747e7e2a5b26d1fa103b04ef48033b5893425afd7917", async() => {
            }
            );
    ...
    <script>
     ...
     ");
                WriteLiteral(@"                                   string += ""<i class='fas fa-star' style='color:#fffc3d; text-shadow: 0 0 2px #000000'></i>"";
                    ...
                    { ""render"": function(data, type, row) {
                            return ""<a href='Offices/Delete/"" + row.id + ""' class='btn btn-danger d-grid ga");
                WriteLiteral(@"p-2'>Xoá</a>"";
                        } 
                    }
                ],
                columnDefs: [
            ...
            $('#toggleButton').click(function(){
                ...
                $(this).val($(this).val() == 'Hiển");
                WriteLiteral(@" thị theo danh sách' ? 'Hiển thị theo thẻ' : 'Hiển thị theo danh sách');
            });
        });
                ...
                if((window.innerHeight + window.scrollY) >= document.body.offsetHeight) {
                    if(ongoing == false) {
                        $.ajax({
                            ...
                            url: '");
#nullable restore
#line 167 "C:\Users\gnoul\Synced Folder\Google Drive\Web\_webapp\VNPT_Review\Views\Offices\Index.cshtml"
                             Write(Url.Action("GetInfiniteOffice", "Offices"));
